...
def get_evaluation_params(base_path):
    datasets = {
        "fda_510ks": {
            ...
            "files": base_path / "fda_510ks/docs/data/evaporate/fda-ai-pmas/510k/*.txt",
        ...
        **{
            f"swde_movie_{site}": {
                ...
                "files": base_path / f"swde_movie_{site}/docs/data/evaporate/swde/movie/movie-{site}(2000)/*.htm",
        ...
        **{
            f"swde_university_{site}": {
                ...
                "files": base_path / f"swde_university_{site}/docs/data/evaporate/swde/university/university-{site}({num})/*.htm",
        ...
        "wiki_nba_players": {
            ...
            "files": base_path / "wiki_nba_players/docs/home/simran/fm-data-analysis/scratch/simran/wiki_nba_player_files.json",
